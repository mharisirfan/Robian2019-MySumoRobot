//// Muhammad Haris Irfan - FA18-BCE-090 -  //// 
const int RM1 = 5;
const int RM2 = 6;
const int LM1 = 7;
const int LM2 = 8;
const int ENA = 9; //left motor
const int ENB = 10; //right motor
const int HORN  = 13;
void setup() {
  ...
  if(Serial.available() > 0){
    ...
    switch(input){
      ...
      case 'G': //Forward left
        ...
        analogWrite(ENA, 220); //left motor controlled enA
        analogWrite(ENB, 0);
...
//// Muhammad Haris Irfan - FA18-BCE-090 - ///
       analogWrite(ENA, 0);
       analogWrite(ENB, 220); //right motor controlled  by enb
